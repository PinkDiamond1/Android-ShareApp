...
public class SampleChooserTargetService extends ChooserTargetService {
    ...
    public List<ChooserTarget> onGetChooserTargets(ComponentName targetActivityName,
        ...
        for (int i = 0; i < ShareContext.SHARE_CONTEXTS.length; ++i) {
            ShareContext shareContext = ShareContext.byId(i);
            Bundle extras = new Bundle();
            extras.putInt(ShareContext.ID, i);
            targets.add(new ChooserTarget(
                    // The name of this target.
                    shareContext.getName(),
                    // The icon to represent this target.
                    Icon.createWithResource(this, shareContext.getIcon(getApplicationContext())),
